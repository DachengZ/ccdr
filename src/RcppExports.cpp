...
// gridCCDr
List gridCCDr(NumericVector cors, List init_betas, unsigned int nn, IntegerVector nj, NumericVector lambdas, NumericVector params, int verbose);
RcppExport SEXP ccdr_gridCCDr(SEXP corsSEXP, SEXP init_betasSEXP, SEXP nnSEXP, SEXP njSEXP, SEXP lambdasSEXP, SEXP paramsSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(gridCCDr(cors, init_betas, nn, nj, lambdas, params, verbose));
    return __result;
END_RCPP
}
// singleCCDr
